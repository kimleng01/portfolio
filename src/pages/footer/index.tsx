...
// import MyImage from "../assets/video-calling.png";
...
function StackedCircularFooterDemo() {
  return (
    <>
            ...
            <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#f5f5f7] to-[#080808] text-white/70">
                <p className="mt-4 text-center">Copyright © 2025 Hean Kimleng. All rights reservered.</p>
                <div id="footer" className="flex items-center gap-4 mt-5">
                    <Link to="https://www.facebook.com/share/1BHQSk3dS5/" className="hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <Link to="https://www.instagram.com/kimleng_09?igsh=a21sY2p3MjMza2F2" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link to="https://www.linkedin.com/in/hean-kimleng-5859b0340?trk=contact-info" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link to="https://github.com/kimleng01" className="hover:-translate-y-0.5 transition-all duration-300">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
